...
public class AmazonClient {
    ...
    @org.springframework.beans.factory.annotation.Value("${amazonProperties.endpointUrl}")
    private String endpointUrl;
    @org.springframework.beans.factory.annotation.Value("${amazonProperties.bucketName}")
